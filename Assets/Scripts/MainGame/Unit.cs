...
public class Unit : MonoBehaviour
{
    ...
    /// </summary>
    public int TotalAttack => Mathf.Max(1, AttackFromLevel + Stats.Attack + Owner.Stats.Attack);

    /// <summary>
    /// Gets the unit's total defence value.
    /// </summary>
    public int TotalDefence => Mathf.Max(1, DefenceFromLevel + Stats.Defence + Owner.Stats.Defence);
